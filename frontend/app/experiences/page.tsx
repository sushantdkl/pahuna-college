...
import { getLiveExperiences } from "@server/services/public-live";
...
export default async function ExperiencesPage() {
  const experiences = await getLiveExperiences();
  ...
  return (
    <>
      ...
      <section className="py-10">
        <Container>
          <ExperiencesMapSectionClient experiences={experiences} />
        </Container>
      </section>
