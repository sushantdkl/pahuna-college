      ...
      <section className="relative hidden min-h-screen w-full flex-1 overflow-hidden lg:flex">
        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-between px-14 py-12 text-white">
          ...
          <div className="pt-10">
            ...
            <button
              type="button"
              className="mt-5 w-52 rounded-full border border-white/30 bg-white/10 px-6 py-2.5 text-[11px] font-semibold uppercase tracking-[0.25em] text-white/90 shadow-lg shadow-black/30 transition hover:bg-white/20"
            >
              Explore Surkhet
            </button>
          </div>
      ...
      <section className="flex min-h-screen w-full flex-1 items-center justify-center bg-gradient-to-b from-white via-emerald-50/40 to-white px-6 py-12 lg:px-12">
        <div className="w-full max-w-[420px] rounded-[32px] border border-emerald-100/70 bg-white/90 p-9 shadow-2xl shadow-emerald-200/70 backdrop-blur">
          <div className="flex flex-col items-center text-center">
            ...
            />
            <h1 className="mt-4 text-3xl font-semibold text-zinc-900">खाता बनाउनुहोस्</h1>
            <p className="mt-2 text-sm text-zinc-500">Create your PAHUNA account to get started</p>
          </div>
          ...
          <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-2">
              <label className="text-xs font-semibold text-zinc-500" htmlFor="fullName">
                Full Name
              </label>
            <input
              id="fullName"
